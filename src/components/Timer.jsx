...
function Timer() {
  // Anniversary date (Set to February 27, 2023, in Philippine Time)
  const START_DATE = new Date('2023-02-27T00:00:00+08:00') // Midnight PHT
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      const days = differenceInDays(nowDate, START_DATE);
      const hours = differenceInHours(nowDate, START_DATE) % 24;
      const minutes = differenceInMinutes(nowDate, START_DATE) % 60;
      const seconds = differenceInSeconds(nowDate, START_DATE) % 60;
    ...
    >
      <div className="text-center z-10">
        ...
        <h1 className="text-lg sm:text-2xl font-bold mb-8 drop-shadow-lg">
          We've been illegally together for:
        </h1>
        ...
        <p className=' text-lg mb-8 drop-shadow-lg'>{`... and still counting after 4 years <3` }</p>
        {/* Button */}
