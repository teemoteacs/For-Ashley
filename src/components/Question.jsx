...
function Question() {
  ...
  const trends = ['Bakit ang pogi ng Bf ko?', 'Bakit mahal na mahal ni Timo si Ash?', `Bakit hindi dapat mag break up ang couple na Timothy at Ashley?`, 'Bakit ang asim asim ni Ashley', 'Bakit ang tangos ng ilong ni Timo']
